...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24761)), "C:\\1231\\react-comp\\src\\app\\(pages)\\blog\\archive\\[id]\\page.jsx"],
...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 51656)), "C:\\1231\\react-comp\\src\\app\\not-found.jsx"],
    ...
    const pages = ["C:\\1231\\react-comp\\src\\app\\(pages)\\blog\\archive\\[id]\\page.jsx"];
    ...
    const originalPathname = "/(pages)/blog/archive/[id]/page"
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "_generateStaticParams": () => (/* binding */ _generateStaticParams),
...
/* harmony import */ var _library_archives__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(82202);
/* harmony import */ var _library_posts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(47092);
...
async function _generateStaticParams() {
    const paths = (0,_library_archives__WEBPACK_IMPORTED_MODULE_7__/* .getAllArchivesIds */ .LN)();
    return paths;
}
...
async function getSingleArchiveData(params) {
    const archiveData = await (0,_library_archives__WEBPACK_IMPORTED_MODULE_7__/* .getArchiveData */ .lt)(params.id);
    if (!archiveData) {
...
async function getAllPosts(params) {
    const archivePosts = await (0,_library_posts__WEBPACK_IMPORTED_MODULE_8__/* .getArchivePosts */ .LE)(params.id);
...
var __webpack_exports__ = __webpack_require__.X(0, [4859,4763,5181,6746,3198,117,4803,2551,2554,9897,8942,4669], () => (__webpack_exec__(61749)));
