...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 51656)), "C:\\1231\\hasan\\src\\app\\not-found.jsx"],
    ...
    const originalPathname = "/(pages)/blog/author/[id]/page"
...
/* harmony import */ var _library_authors__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(50863);
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_PageBanner__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .ZP, {
                pageTitle: "Author: " + authorData.title,
                breadTitle: authorData.title,
...
;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BlogAuthor);
async function generateStaticParams() {
    const paths = (0,_library_authors__WEBPACK_IMPORTED_MODULE_7__/* .getAllAuthorsIds */ .g_)();
    return paths;
}
...
async function getSingleAuthorData(params) {
    const authorData = await (0,_library_authors__WEBPACK_IMPORTED_MODULE_7__/* .getAuthorData */ .j0)(params.id);
    if (!authorData) {
...
async function getAllPosts(params) {
    const authorPosts = await (0,_library_posts__WEBPACK_IMPORTED_MODULE_8__/* .getAuthorPosts */ .UZ)(params.id);
