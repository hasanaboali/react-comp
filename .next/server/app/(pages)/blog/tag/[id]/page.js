...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1948)), "C:\\1231\\react-comp\\src\\app\\(pages)\\blog\\tag\\[id]\\page.jsx"],
...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 51656)), "C:\\1231\\react-comp\\src\\app\\not-found.jsx"],
    ...
    const pages = ["C:\\1231\\react-comp\\src\\app\\(pages)\\blog\\tag\\[id]\\page.jsx"];
    ...
    const originalPathname = "/(pages)/blog/tag/[id]/page"
...
/* harmony import */ var _library_tags__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(63931);
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_PageBanner__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .ZP, {
                pageTitle: "Tag: " + tagData.title,
                breadTitle: tagData.title,
...
async function generateStaticParams() {
    const paths = (0,_library_tags__WEBPACK_IMPORTED_MODULE_7__/* .getAllTagsIds */ .cT)();
    return paths;
}
...
async function getSingleTagData(params) {
    const tagData = await (0,_library_tags__WEBPACK_IMPORTED_MODULE_7__/* .getTagData */ .w5)(params.id);
    if (!tagData) {
...
async function getAllPosts(params) {
    const tagPosts = await (0,_library_posts__WEBPACK_IMPORTED_MODULE_8__/* .getTagPosts */ .Qj)(params.id);
    if (!tagPosts.length) {
        (0,next_navigation__WEBPACK_IMPORTED_MODULE_5__.notFound)();
    }
    return tagPosts;
...
var __webpack_exports__ = __webpack_require__.X(0, [4859,4763,5181,6746,3198,117,4803,2551,2554,9897,8942,4669], () => (__webpack_exec__(89271)));
