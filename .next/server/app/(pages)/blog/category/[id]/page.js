...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 51212)), "C:\\1231\\react-comp\\src\\app\\(pages)\\blog\\category\\[id]\\page.jsx"],
...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 51656)), "C:\\1231\\react-comp\\src\\app\\not-found.jsx"],
    ...
    const pages = ["C:\\1231\\react-comp\\src\\app\\(pages)\\blog\\category\\[id]\\page.jsx"];
    ...
    const originalPathname = "/(pages)/blog/category/[id]/page"
...
/* harmony import */ var _components_PageBanner__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(33814);
/* harmony import */ var _components_Sidebar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(43564);
/* harmony import */ var _components_PaginatedBlog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(64954);
/* harmony import */ var next_navigation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(80117);
/* harmony import */ var next_navigation__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(next_navigation__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _library_categories__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(39863);
/* harmony import */ var _library_posts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(47092);
...
async function BlogCategory({ params  }) {
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_PageBanner__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .ZP, {
                pageTitle: "Category: " + categoryData.title,
                breadTitle: categoryData.title,
                                        ...
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                            ...
                                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                ...
                                                children: [
                                                    ...
                                                    categories.map((item, key)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_1___default()), {
                                                            href: `/blog/category/${item.id}`,
                                                            className: item.id == params.id ? "mil-current" : "",
                                                            children: item.title
                                                        }, `categories-item-${key}`))
                                                ]
                                            })
                                        }),
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_PaginatedBlog__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {
                                            items: posts
                                        })
                                    ]
                                }),
...
;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BlogCategory);
async function generateStaticParams() {
    const paths = (0,_library_categories__WEBPACK_IMPORTED_MODULE_6__/* .getAllCategoriesIds */ .oo)();
    return paths;
}
async function getAllCategories() {
    const categoriesData = await (0,_library_categories__WEBPACK_IMPORTED_MODULE_6__/* .getSortedCategoriesData */ .HB)();
    return categoriesData;
}
async function getSingleCategoryData(params) {
    const categoryData = await (0,_library_categories__WEBPACK_IMPORTED_MODULE_6__/* .getCategoryData */ .HI)(params.id);
    if (!categoryData) {
...
async function getAllPosts(params) {
    const categoryPosts = await (0,_library_posts__WEBPACK_IMPORTED_MODULE_7__/* .getCategoryPosts */ .S2)(params.id);
...
var __webpack_exports__ = __webpack_require__.X(0, [4859,4763,5181,6746,3198,117,4803,2551,2554,9897,8942,4669], () => (__webpack_exec__(55945)));
