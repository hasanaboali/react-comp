...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 51656)), "C:\\1231\\react-comp\\src\\app\\not-found.jsx"],
    ...
    const originalPathname = "/(pages)/search/page"
...
;// CONCATENATED MODULE: ./src/app/_lib/date.js
...
function date_Date({ dateString  }) {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("time", {
        dateTime: dateString,
        children: (0,date_fns.format)(date, "dd.MM.yyyy")
    });
}
...
async function FilteredBlogPosts({ posts  }) {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
        children: searchResults.length > 0 && /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
            children: searchResults.map((item, index)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)((link_default()), {
                    href: `/blog/${item.id}`,
                        ...
                        /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                    className: "mil-date",
                                    children: /*#__PURE__*/ jsx_runtime_.jsx(date_Date, {
...
;
/* harmony default export */ const FilteredBlog = (FilteredBlogPosts);
...
/* harmony default export */ const FilteredBlog = (__default__);
...
// EXTERNAL MODULE: ./src/app/_components/Sidebar.jsx + 1 modules
var Sidebar = __webpack_require__(43564);
// EXTERNAL MODULE: ./src/app/_lib/posts.js
var _lib_posts = __webpack_require__(47092);
// EXTERNAL MODULE: external "fs"
var external_fs_ = __webpack_require__(57147);
;// CONCATENATED MODULE: ./src/app/(pages)/search/page.jsx
...
async function Search() {
    const generateJsonPosts = await (0,_lib_posts/* generateJsonPostsData */.Lx)();
    const file = await external_fs_.promises.readFile(process.cwd() + "/src/data/.json/posts.json", "utf8");
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                            ...
                            children: [
                                /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                    className: "col-lg-7",
                                    children: /*#__PURE__*/ jsx_runtime_.jsx(FilteredBlog, {
                                        posts: posts
                                    })
                                }),
                                /*#__PURE__*/ jsx_runtime_.jsx("div", {
...
;
/* harmony default export */ const page = (Search);
